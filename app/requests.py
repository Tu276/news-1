...
def process_results(movie_list):
    ...
    return movie_results  # empty list to store our newly cereated movie objects
...
def get_movie(id):
    ...
    # We then create a request and load the data and create a movie object. views.py
    return movie_object
